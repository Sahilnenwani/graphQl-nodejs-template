...
describe("User methods", () => {
  ...
  test("addNew method should add new user in user table", async () => {
    ...
    expect(userData.name).toEqual(userFormDatabase.name)
    expect(userData.age).toEqual(userFormDatabase.age)
    expect(userData.dateOfBirth).toEqual(userFormDatabase.dateOfBirth)
  })
